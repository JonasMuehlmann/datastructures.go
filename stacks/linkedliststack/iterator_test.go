...
func TestLinkedListStackIteratorIsValid(t *testing.T) {
	tests := []struct {
		name         string
		list         *Stack[int]
		position     int
...
func TestLinkedListStackIteratorIndex(t *testing.T) {
	tests := []struct {
		name         string
		list         *Stack[int]
		position     int
...
func TestLinkedListStackIteratorNext(t *testing.T) {
	tests := []struct {
		name          string
		list          *Stack[int]
		position      int
...
func TestLinkedListStackIteratorNextN(t *testing.T) {
	tests := []struct {
		name          string
		list          *Stack[int]
		position      int
...
func TestLinkedListStackIteratorGet(t *testing.T) {
	tests := []struct {
		name     string
		list     *Stack[int]
		position int
...
func TestLinkedListStackIteratorSet(t *testing.T) {
	tests := []struct {
		name        string
		list        *Stack[int]
		position    int
...
func TestLinkedListStackIteratorIsAfter(t *testing.T) {
	tests := []struct {
		name      string
		position1 int
		position2 int
...
func TestLinkedListStackIteratorIsBefore(t *testing.T) {
	tests := []struct {
		name      string
		position1 int
		position2 int
...
func TestLinkedListStackIteratorIsEqual(t *testing.T) {
	tests := []struct {
		name      string
		position1 int
		position2 int
...
func TestLinkedListStackIteratorSize(t *testing.T) {
	tests := []struct {
		name         string
		list         *Stack[int]
		iteratorInit func(*Stack[int]) ds.ReadWriteOrdCompForRandCollIterator[int]
