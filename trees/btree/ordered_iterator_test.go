...
func TestBTreeOrderedIteratorIndex(t *testing.T) {
	tests := []struct {
		name         string
		map_         *Tree[string, int]
		key          string
...
func TestBTreeOrderedIteratorSize(t *testing.T) {
	tests := []struct {
		name string
		map_ *Tree[string, int]
		size int
...
func TestBTreeOrderedIteratorNext(t *testing.T) {
	tests := []struct {
		name          string
		map_          *Tree[string, int]
		position      string
...
func TestBTreeOrderedIteratorNextN(t *testing.T) {
	tests := []struct {
		name          string
		map_          *Tree[string, int]
		position      string
...
func TestBTreeOrderedIteratorPrevious(t *testing.T) {
	tests := []struct {
		name          string
		map_          *Tree[string, int]
		position      string
...
func TestBTreeOrderedIteratorPreviousN(t *testing.T) {
	tests := []struct {
		name          string
		map_          *Tree[string, int]
		position      string
...
func TestBTreeOrderedIteratorMoveBy(t *testing.T) {
	tests := []struct {
		name          string
		map_          *Tree[string, int]
		position      string
...
func TestBTreeOrderedIteratorMoveToKey(t *testing.T) {
	tests := []struct {
		name         string
		map_         *Tree[string, int]
		position     string
