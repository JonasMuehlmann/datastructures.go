...
func TestRedBlackTreeOrderedIteratorIsValid(t *testing.T) {
	tests := []struct {
		name         string
...
func TestRedBlackTreeOrderedIteratorGet(t *testing.T) {
	tests := []struct {
		name     string
		map_     *Tree[string, int]
		position string
...
func TestRedBlackTreeOrderedIteratorSet(t *testing.T) {
	tests := []struct {
		name        string
		map_        *Tree[string, int]
		position    string
...
func TestRedBlackTreeOrderedIteratorDistanceTo(t *testing.T) {
	tests := []struct {
		name     string
		map_     *Tree[string, int]
		key1     string
...
func TestRedBlackTreeOrderedIteratorIsAfter(t *testing.T) {
	tests := []struct {
		name    string
		map_    *Tree[string, int]
		key1    string
...
func TestRedBlackTreeOrderedIteratorIsBefore(t *testing.T) {
	tests := []struct {
		name    string
		map_    *Tree[string, int]
		key1    string
...
func TestRedBlackTreeOrderedIteratorIsEqual(t *testing.T) {
	tests := []struct {
		name      string
		position1 string
		position2 string
