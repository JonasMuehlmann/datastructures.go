...
func TestAVLTreeOrderedIteratorIsValid(t *testing.T) {
	tests := []struct {
		name         string
		...
		{
			name:         "Empty",
			map_:         New[string, int](utils.BasicComparator[string]),
			isValid:      false,
...
func TestAVLTreeOrderedIteratorGet(t *testing.T) {
	tests := []struct {
		name     string
		map_     *Tree[string, int]
		position string
...
func TestAVLTreeOrderedIteratorSet(t *testing.T) {
	tests := []struct {
		name        string
		map_        *Tree[string, int]
		position    string
...
func TestAVLTreeOrderedIteratorGetAtKey(t *testing.T) {
	tests := []struct {
		name     string
		map_     *Tree[string, int]
		position string
...
func TestAVLTreeOrderedIteratorSetAtKey(t *testing.T) {
	tests := []struct {
		name        string
		map_        *Tree[string, int]
		position    string
...
func TestAVLTreeOrderedIteratorDistanceTo(t *testing.T) {
	tests := []struct {
		name     string
		map_     *Tree[string, int]
		key1     string
...
func TestAVLTreeOrderedIteratorIsAfter(t *testing.T) {
	tests := []struct {
		name    string
		map_    *Tree[string, int]
		key1    string
...
func TestAVLTreeOrderedIteratorIsBefore(t *testing.T) {
	tests := []struct {
		name    string
		map_    *Tree[string, int]
		key1    string
...
func TestAVLTreeOrderedIteratorIsEqual(t *testing.T) {
	tests := []struct {
		name      string
		position1 string
		position2 string
