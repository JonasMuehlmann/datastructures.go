...
func TestHashMapOrderedIteratorIsBeginEndFirstLast(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			name:          "OrderedLast",
			iteratorInit:  (*Map[string, int]).OrderedLast,
			iteratorCheck: (ds.ReadWriteUnordCompBidRandCollIterator[string, int]).IsLast,
		},
		{
			name:          "OrderedBegin",
			iteratorInit:  (*Map[string, int]).OrderedBegin,
			iteratorCheck: (ds.ReadWriteUnordCompBidRandCollIterator[string, int]).IsBegin,
		},
		{
			name:          "OrderedEnd",
			iteratorInit:  (*Map[string, int]).OrderedEnd,
			iteratorCheck: (ds.ReadWriteUnordCompBidRandCollIterator[string, int]).IsEnd,
		},
	}
