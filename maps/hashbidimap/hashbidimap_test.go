// Copyright (c) 2022, Jonas Muehlmann. All rights reservedmtr
...
func TestHashBidiMapRemove(t *testing.T) {
	tests := []struct {
		name        string
...
func TestHashBidiMapPut(t *testing.T) {
	tests := []struct {
		name        string
		originalMap *Map[string, int]
		newMap      *Map[string, int]
...
func TestHashBidiMapGet(t *testing.T) {
	tests := []struct {
		name        string
		originalMap *Map[string, int]
		keyToGet    string
...
func TestHashBidiMapGetKeys(t *testing.T) {
	tests := []struct {
		name        string
		originalMap *Map[string, int]
		keys        []string
...
func TestHashBidiMapGetValues(t *testing.T) {
	tests := []struct {
		name        string
		originalMap *Map[string, int]
		values      []int
...
func TestHashBidiMapIsEmpty(t *testing.T) {
	tests := []struct {
		name        string
		originalMap *Map[string, int]
		isEmpty     bool
...
func TestHashBidiMapClear(t *testing.T) {
	tests := []struct {
		name          string
		originalMap   *Map[string, int]
		isEmptyBefore bool
...
func TestHashBidiMapNewFromIterator(t *testing.T) {
	tests := []struct {
		name        string
		originalMap *Map[string, int]
	}{
...
func TestHashBidiMapNewFromIterators(t *testing.T) {
	tests := []struct {
		name        string
		originalMap *Map[string, int]
	}{
